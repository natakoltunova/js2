...
function haveFood(unit) {
  ...
  if (unit_classes.includes('food-unit')) {
    ...
    score++
    document.getElementById('counter').appendChild(unit_counter.toString())
  }
  return check
}

var unit_counter = setInterval(function () {
  var date = new Date()
  document.getElementById('counter').innerHTML = 'ОЧКИ: ' + score
}, 1000)
